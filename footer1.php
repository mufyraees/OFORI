...
<div data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="site-section cta-big-image" id="about-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
            <h2 class="section-title mb-3">About O FO RI </h2>
          </div>
        </div>
        <div class="row">
      ...
      <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
        <div class="mb-4">
          <h3 class="h3 mb-4 text-black">MENTAL HEALTH DEVELOPMENT</h3>
			  <h3 class="h3 mb-4 text-black">ONLINE ASSESMENT TEST</h3>
        </div>
    ...
    <section class="site-section" id="about-section"></section>
<section class="site-section" id="blog-section"></section>
